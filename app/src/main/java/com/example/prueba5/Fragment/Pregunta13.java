...
public class Pregunta13 extends Fragment {
    ...
    int nauseac=0;
    int nauseaz=0;
    RadioButton btnTengonausea;
    RadioButton btnNotengonausea;
    View view;
    Activity actividad;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnTengonausea=view.findViewById(R.id.radioButtonPresentonausea);
        btnNotengonausea=view.findViewById(R.id.radioButtonNoPpresentonausea);

        btnTengonausea.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (btnTengonausea.isChecked()==true){
                    nausead+=3;
                    nauseac+=2;
                    nauseaz+=1;
                }
        ...
        btnNotengonausea.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (btnNotengonausea.isChecked()==true){
                    nausead+=0;
                    nauseac+=0;
                    nauseaz+=0;
                }
